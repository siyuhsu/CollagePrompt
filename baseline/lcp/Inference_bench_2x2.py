...
import numpy as np
import pygad
from util.utils import ord_grid_adj_2x2
from util.data_loader import  Imagenet2x2GridDataset


class Bench2x2GridTestSet(InMemoryDataset):
...
parser.add_argument('--save_path', type=str, default='weights/weights_train_2x2', help='Save Checkpoints')


parser.add_argument('--save_pred_path', type=str, default='baseline/lcp/results/ucf101_2x2_pred_ga.json', help='Save json')
...
testset = Bench2x2GridTestSet(
                 meta_file="dataset/val/ucf101/metainfo/ucf101_test_2x2_collage_info.json", 
                 collage_dir="dataset/val/ucf101/collage/2x2",
                 img_dir="dataset/val/ucf101/set/feat", 
                 processed_path = "baseline/lcp/processed/ucf101_2x2_pyg.pt")
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("baseline/lcp/weights/weights_train_2x2/499.pth", map_location=args.device))
