...
from util.utils import process_adj, ord_grid_adj
import numpy as np
import pygad
from util.data_loader import  ImagenetGridDataset, ImagenetGridTestSet
...
parser.add_argument('--save_path', type=str, default='./weights_train', help='Save Checkpoints')
parser.add_argument('--save_pred_path', type=str, default='./pred_3x3/imagenet_val_3x3_pred_btf_1k_s1500.json', help='Save json')
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load("./weights_train/499.pth", map_location=args.device))
